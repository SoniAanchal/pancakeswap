...
const WalletInfo: React.FC<WalletInfoProps> = ({ hasLowBnbBalance, onDismiss }) => {
  ...
  return (
    <>
      <Text color="#009999" fontSize="12px" textTransform="uppercase" fontWeight="bold" mb="8px">
        {t('Your Address')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="space-between">
        <Text color="#0099ff ">{t('BNB Balance')}</Text>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="24px">
        <Text color="#0099ff">{t('CAKE Balance')}</Text>
      ...
      <Button variant="primary"  width="100%" onClick={handleLogout}>
        {t('Disconnect Wallet')}
      </Button>
    </>
  )
