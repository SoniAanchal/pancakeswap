    ...
    <Footer p="16px" flexDirection="column">
      ...
      {isExpanded && (
        <Box px="8px">
              ...
              <>
                ...
                <Flex justifyContent="flex-end" alignItems="flex-end">
                  ...
                  <span ref={multiplierRef}>
                    <HelpIcon color="#0099ff" width="16px" height="16px" />
                  </span>
          ...
          <BulletList>
            <li>
              <Text fontSize="12px" textAlign="center" color="#0099ff" display="inline">
            ...
            {performanceFee > 0 && (
              <li>
                <Text mt="14px" fontSize="12px" textAlign="center" color="#0099ff" display="inline">
