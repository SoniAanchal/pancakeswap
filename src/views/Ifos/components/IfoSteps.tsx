...
const Step1 = ({ hasProfile }: { hasProfile: boolean }) => {
  ...
  return (
    <CardBody style= {{background: 'linear-gradient(180deg, #00ffff 0%, #8080ff 100%)'}} >
      {tooltipVisible && tooltip}
      <Heading as="h4" color="#000080" mb="16px">
      ...
      <Box>
        ...
        <TooltipText as="span" fontWeight={700} ref={targetRef} color="#0099ff" small>
        ...
        <SmallStakePoolCard borderRadius="default" p="16px">
          <FlexGap justifyContent="space-between" alignItems="center" flexWrap="wrap" gap="16px">
            <Flex>
              ...
              <Box ml="16px">
                <Text bold fontSize="12px" textTransform="uppercase" color="#009999">
...
const IfoSteps: React.FC<Props> = ({ ifo, walletIfoData, isLive }) => {
      ...
      case 0:
        return (
          <CardBody style= {{background: 'linear-gradient(180deg, #00ffff 0%, #8080ff 100%)'}}>
            ...
            <Text color="black" small mb="16px">
  ...
  return (
    <Wrapper>
      <Heading id="ifo-how-to" as="h2" scale="xl" color="#00ace6" mb="24px" textAlign="center">
        {t('How to Take Part')}
      </Heading>
      <Stepper >
