        ...
        <Flex justifyContent="flex-end" flexDirection="column">
          ...
          {account && (
            <Flex justifyContent="flex-end">
              <Text fontSize="12px" color="#0099ff" mr="4px">
                CAKE {t('Balance')}:
              </Text>
              {hasFetchedBalance ? (
      ...
      <Flex flexDirection="column">
        ...
        <Flex mb="8px" justifyContent="space-between">
          <Flex>
            ...
            <Text display="inline" color="#0099ff" fontSize="14px">
              {t('Bulk discount')}
            </Text>
            <Flex alignItems="center" justifyContent="center" ref={targetRef}>
              <HelpIcon ml="4px" width="14px" height="14px" color="#0099ff" />
            </Flex>
          </Flex>
          <Text fontSize="14px" color="#0099ff">
            ~{discountValue} CAKE
          </Text>
        </Flex>
        <Flex borderTop={`1px solid ${theme.colors.cardBorder}`} pt="8px" mb="24px" justifyContent="space-between">
          <Text color="#0099ff" fontSize="16px">
            {t('You pay')}
          </Text>
        ...
        <Text mt="24px" fontSize="12px" color="#0099ff">
          {t(
