...
const PreviousRoundTicketsInner: React.FC<{ roundId: string }> = ({ roundId }) => {
      ...
      return (
        <div ref={targetRef}>
          <Flex alignItems="center" justifyContent="center" mt="20px">
            <InfoIcon height="20px" width="20px" color="#0099ff" mr="8px" />
            <TooltipText color="#0099ff">{t("Why didn't I win?")}</TooltipText>
          </Flex>
        </div>
      )
    }
  ...
  return (
    <>
      ...
      <TopBox>
        <Text bold textTransform="uppercase" color="#009999" fontSize="12px" mb="4px">
          {t('Winning number')}
        </Text>
      ...
      <ScrollBox>
        <Text bold textTransform="uppercase" color="#009999" fontSize="12px" my="16px">
          {t('Your tickets')}
        </Text>
