...
const RoundResult: React.FC<RoundResultProps> = ({ round, children, ...props }) => {
  ...
  return (
    <RoundResultBox betPosition={betPosition} {...props}>
      <Text color="#0099ff" fontSize="12px" bold textTransform="uppercase" mb="8px">
        {t('Closed Price')}
      </Text>
      {round.failed ? (
        <Text bold textTransform="uppercase" color="#ff9900" mb="16px" fontSize="24px">
          {t('Canceled')}
        </Text>
      ) : (
        <Flex alignItems="center" justifyContent="space-between" mb="16px">
          <Text color={isPositionUp ? '#00b300' : '#cc0000'} bold fontSize="24px">
