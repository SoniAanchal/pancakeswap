    ...
    <Card onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
      <CardHeader p="16px">
        <Flex alignItems="center">
          <IconButton variant="text" scale="sm" onClick={handleGoBack} mr="8px" >
            <ArrowBackIcon width="24px" color=" #0099ff" />
          </IconButton>
          <FlexRow>
            <Heading scale="md" color=" #0099ff">{t('Set Position')}</Heading>
          </FlexRow>
      ...
      <CardBody py="16px">
        <Flex alignItems="center" justifyContent="space-between" mb="8px">
          <Text textAlign="right" color=" #0099ff">
            {t('Commit')}:
          </Text>
          <Flex alignItems="center">
            <BinanceIcon mr="4px  " />
            <Text bold textTransform="uppercase" color=" #0099ff">
              BNB
            </Text>
          </Flex>
        </Flex>
        ...
        />
        {showFieldWarning && (
          <Text color="#cc0000" fontSize="12px" mt="4px" textAlign="right">
            {t(errorMessage.key, errorMessage.data)}
          </Text>
        )}
        <Text textAlign="right" mb="16px" color="#009999" fontSize="12px" style={{ height: '18px' }}>
        ...
        <Text as="p" fontSize="12px" lineHeight={1} color="#0099ff">
