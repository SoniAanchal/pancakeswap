...
const LiveRoundCard: React.FC<LiveRoundCardProps> = ({
  ...
  const priceColor = isBull ? '#00b300' : '#cc0000'
  ...
  return (
    <Card isActive>
      <CardHeader
        status="live"
        icon={<PlayCircleOutlineIcon mr="4px" width="24px" color="#009999" />}
        title={t('Live')}
        epoch={round.epoch}
      />
      ...
      <CardBody p="16px">
        ...
        <RoundResultBox betPosition={isBull ? BetPosition.BULL : BetPosition.BEAR}>
          <Text color="#009999" fontSize="12px" bold textTransform="uppercase" mb="8px">
            {t('Last Price')}
          </Text>
