...
const TradingCompetition = () => {
  ...
  return (
    <CompetitionPage>
      ...
      <PageSection style={{background:'linear-gradient(139.73deg,  #ffe6ee 0%, #008080 60%, #ffe6ee 100%)'}}
        containerProps={{ style: { marginTop: '-30px' } }}
        index={3}
        concaveDivider
      ...
      <PageSection style={{background:'linear-gradient(139.73deg,  #999999 0%, #ffffcc 60%, #999999 100%)'}}
        containerProps={{ style: { marginTop: '-30px' } }}
        dividerComponent={
        ...
        concaveDivider
        clipFill={{
          light: 'linear-gradient(139.73deg, #008080 0%, #ecf6ff 100%)',
      ...
      <PageSection
        ...
        dividerPosition="top"
        clipFill={{
          light: 'linear-gradient(139.73deg, #008080 0%, #f2effe 100%)',
