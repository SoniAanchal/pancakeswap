...
const BattleBanner = () => {
  ...
  return (
    <Flex flexDirection="column" >
      ...
      <StyledText mb="16px" color="#006666" bold>
        {new Date(2020, 11).toLocaleString(locale, {
          month: 'short',
        })}{' '}
        14-20, 2021
      </StyledText>
      <StyledHeading1Text background="#00394d" $fill >{t('Binance Fan Token Trading Competition')}</StyledHeading1Text>
      <StyledHeading2Text background={theme.colors.gradients.gold} $fill>
        {t('$120,000 in Prizes!')}
      </StyledHeading2Text>
      <StyledHeading scale="md" color={theme.isDark ? '#006666' : '#006666'} mt="16px">
