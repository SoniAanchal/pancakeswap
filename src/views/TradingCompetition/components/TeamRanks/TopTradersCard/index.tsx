...
const TopTradersCard: React.FC<TeamRanksProps> = ({
  ...
  return (
    <Card id="top-traders-card"  style={{background:'linear-gradient(180deg,#FFD800 0%,#FDAB32 100%)'}}>
      <Box width="100%">
        <CardHeader >
          <Heading color="#009900" scale="lg">
            {t('Top Traders')}
          </Heading>
          <Text fontSize="14px" color="#009900">
            {t('Since start of the competition')}
          </Text>
        </CardHeader>
        <Box mt="16px"  style={{background:'linear-gradient(180deg,#d9d9d9 0%, #c2d6d6 100%)'}} >
