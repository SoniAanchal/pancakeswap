...
const FAQ = () => {
  ...
  return (
    <Wrapper >
      <Card >
        <CardHeader>
          <Heading scale="lg" color="#ffcc00">{t('Details')}</Heading>
        </CardHeader>
        <StyledCardbody style={{background:'linear-gradient(139.73deg, rgb(255, 230, 238) 0%, #99ccff 60%, rgb(255, 230, 238) 100%)'}}>
          <FoldableText  color="#004d4d" title={t('Eligible trading pairs')} mt="24px" >
            <Text fontSize="14px" color="#004d4d">
              {t(
