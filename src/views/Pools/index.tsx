...
const Pools: React.FC = () => {
  ...
  return (
    <>
      <PageHeader style={{background:"linear-gradient(139.73deg,#000033 0%,#008080 60%,#000033 100%)"}} role="table" >
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            <Heading as="h1" scale="xxl" color="white" mb="0px" >
              {t('Syrup Pools')}
            </Heading>
            <Heading scale="md" color='white' >
              {t('Just stake some tokens to earn.')}
            </Heading>
            <Heading scale="md" color='green'>
              {t('High APR, low risk.')}
            </Heading>
          </Flex>
      ...
      <Page >
        <PoolControls>
          ...
          <FilterContainer >
            <LabelWrapper >
              <Text fontSize="12px" bold color="#0099ff" textTransform="uppercase">
                {t('Sort by')}
              </Text>
              <ControlStretch>
                <Select
