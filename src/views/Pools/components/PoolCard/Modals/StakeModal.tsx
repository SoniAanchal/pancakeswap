  ...
  return (
    ...
    >
      {stakingLimit.gt(0) && !isRemovingStake && (
        <Text color="#009999" bold mb="24px" style={{ textAlign: 'center' }} fontSize="16px">
      ...
      <Text ml="auto" color="#0099ff" fontSize="12px" mb="8px">
        {t('Balance: %balance%', {
          ...
          {Number.isFinite(annualRoi) ? (
            ...
            >
              ...
              <IconButton variant="text" scale="sm">
                <CalculateIcon color="#0099ff" width="18px" />
              </IconButton>
            </AnnualRoiContainer>
          ) : (
            <Skeleton width={60} />
