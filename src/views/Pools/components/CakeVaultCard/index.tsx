    ...
    <Flex  mt="8px" justifyContent="space-between">
      ...
      <Flex mr="6px" alignItems="center">
        <Link
          ...
          mr="4px"
          color={hasEndBlockOver ? 'warning' : 'black'}
          fontSize="14px"
        >
...
const CakeVaultCard: React.FC<CakeVaultProps> = ({ pool, showStakedOnly, defaultFooterExpanded, ...props }) => {
  ...
  return (
    <StyledCard isActive {...props} style= {{background: 'linear-gradient(180deg,#ffe6e6 0%,#ffe066 100%)'}}>
        ...
        <FlexGap mt="16px" gap="24px" flexDirection={accountHasSharesStaked ? 'column-reverse' : 'column'}>
          ...
          <Flex flexDirection="column" >
            {account ? (
              ...
              <>
                <Text mb="10px" textTransform="uppercase" fontSize="12px" color="#00cc00" bold>
                  {t('Start earning')}
                </Text>
                <ConnectWalletButton />
              </>
