  ...
  return (
    <Flex justifyContent="space-between" alignItems="center">
      <Flex flexDirection="column">
        ...
        <Text as={Flex} fontSize="12px" color="color" flexWrap="wrap">
          {cakePriceBusd.gt(0) ? (
            <Balance value={stakedDollarValue} fontSize="12px" color="black" decimals={2} prefix="~" unit=" USD" />
          ) : (
