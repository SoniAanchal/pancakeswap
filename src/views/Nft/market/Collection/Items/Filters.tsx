...
const Filters: React.FC<FiltersProps> = ({ collection }) => {
  ...
  return (
    <GridContainer>
      <FilterByTitle textTransform="uppercase" color="#0099ff" fontSize="12px" bold>
        {t('Filter by')}
      </FilterByTitle>
      <FilterByControls>
      ...
      <SortByTitle fontSize="12px" textTransform="uppercase" color="#0099ff" fontWeight={600} mb="4px">
        {t('Sort By')}
      </SortByTitle>
      <SortByControls>
