          ...
          <TableHeading flex="0 1 auto" gridTemplateColumns="2fr 2fr 1fr" py="12px">
            <StyledSortButton type="button" onClick={togglePriceSort}>
              <Flex alignItems="center">
                <Text textTransform="uppercase" color="#0099ff" bold fontSize="12px" px="24px">
                  {t('Price')}
                </Text>
                {priceSort === 'asc' ? <ArrowUpIcon color="#0099ff" /> : <ArrowDownIcon color="#0099ff" />}
              </Flex>
            </StyledSortButton>
            <Text textTransform="uppercase" color="#0099ff" bold fontSize="12px">
              {t('Owner')}
            </Text>
          </TableHeading>
