    ...
    <Flex p="16px" flexDirection="column">
      <Flex mb="8px" alignItems="center">
        <Flex flexDirection="column">
          ...
          {!isApproved && (
            <Text mt="8px" maxWidth="275px" small color="#0099ff">
              {variant === 'buy'
      ...
      <Flex alignItems="center" mt="8px">
        <Flex flexDirection="column">
          ...
          <Text small color={isApproved ? '#0099ff ' : 'textDisabled'}>
      ...
      <Button mt="16px" disabled={!isApproved || isConfirming} onClick={handleConfirm} variant="primary" >
