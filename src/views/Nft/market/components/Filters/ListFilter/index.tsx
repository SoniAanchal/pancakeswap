        ...
        >
          <Box maxWidth="375px" ref={menuRef}>
            <SearchWrapper alignItems="center" p="16px">
              <InputGroup startIcon={<SearchIcon color="#0099ff" />}>
            ...
            <Flex alignItems="center" p="16px">
              <FilterButton onClick={toggleSort('label')} style={{ flex: 1 }}>
                <Text fontSize="12px" color="#009999" fontWeight="bold" textTransform="uppercase">
                  {t('Name')}
                </Text>
                <Box width="18px">
                  {orderKey === 'label' && orderDir === 'asc' && <ArrowUpIcon width="18px" color="#009999" />}
                  {orderKey === 'label' && orderDir === 'desc' && <ArrowDownIcon width="18px" color="#009999" />}
                </Box>
              </FilterButton>
              <FilterButton onClick={toggleSort('count')}>
                ...
                <Box width="18px">
                  {orderKey === 'count' && orderDir === 'asc' && <ArrowUpIcon width="18px" color="#009999" />}
                  {orderKey === 'count' && orderDir === 'desc' && <ArrowDownIcon width="18px" color="#009999" />}
                </Box>
              </FilterButton>
            </Flex>
