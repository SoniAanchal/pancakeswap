...
const ActivityHistory: React.FC<ActivityHistoryProps> = ({ collection }) => {
  ...
  return (
    <Box py="32px" style={{background:'linear-gradient(139.73deg, rgb(153, 153, 153) 0%, rgb(255, 255, 204) 60%, rgb(153, 153, 153) 100%)'}}>
      <Container px={[0, null, '32px']}>
        <Flex
          ...
          <>
            ...
            >
              <PageButtons>
                ...
                >
                  <ArrowBackIcon color={paginationData.currentPage === 1 ? 'textDisabled' : '#000099'} />
                </Arrow>
                <Text color=" #800000">
                ...
                >
                  <ArrowForwardIcon
                    color={paginationData.currentPage === paginationData.maxPage ? 'textDisabled' : '#000099'}
                  />
                </Arrow>
              </PageButtons>
            </Flex>
