    ...
    <ModalContainer minWidth="375px">
      ...
      <ModalBody py="24px" maxWidth="375px" width="100%">
        <Flex flexDirection="column">
          <Box px="16px">
            <Text fontSize="12px" fontWeight="600" textTransform="uppercase" color="#009999" mb="16px">
              {t('Buy how many?')}
            </Text>
            ...
            <Flex mb="8px" justifyContent="space-between">
              <Text font-size="14px" color="#0099ff">
                {t('Cost per Ticket')}
              </Text>
          ...
          >
            <Box>
              <InfoIcon width="20px" mt="4px" mr="10px" color="#0099ff" />
            </Box>
            <Box>
              <Text font-size="12px" color="#0099ff" mb="12px">
                {t('The network may become busy during the sale period. Consider setting a high gas fee (GWEI).')}
              </Text>
              <Text font-size="12px" color="#0099ff">
