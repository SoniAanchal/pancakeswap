  ...
  return (
    <StyledBunnySectionContainer justifyContent={['flex-start', null, null, 'center']}>
      ...
      >
        ...
        >
          <ColoredWordHeading text={headingText} color="#0099ff" mb="0" />
          <ColoredWordHeading text={subHeadingText} color="#0099ff" firstColor="failure" />
          {bodyText.map((text) => (
            <Text key={text} color="#0099ff" mb="20px">
              {text}
            </Text>
          ))}
          <Flex>
            <Link to={primaryButton.to}>
              <Button>
                <Text color="#00394d" bold fontSize="16px">
