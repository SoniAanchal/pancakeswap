      ...
      <AppBody>
        ...
        <CardBody>
          ...
          {!showDetailed && (
            <>
              <ColumnCenter>
                <ArrowDownIcon color="#0099ff" width="24px" my="16px" />
              </ColumnCenter>
              <AutoColumn gap="10px">
                <Text bold color="#009999" fontSize="12px" textTransform="uppercase">
                  {t('You will receive')}
                </Text>
                <LightGreyCard>
                  <Flex justifyContent="space-between" mb="8px">
                    <Flex>
                      ...
                      <Text small color="#0099ff" id="remove-liquidity-tokena-symbol" ml="4px">
                        {currencyA?.symbol}
                      </Text>
                    </Flex>
                  ...
                  <Flex justifyContent="space-between">
                    <Flex>
                      ...
                      <Text small color="#0099ff" id="remove-liquidity-tokenb-symbol" ml="4px">
                        {currencyB?.symbol}
                      </Text>
                    </Flex>
