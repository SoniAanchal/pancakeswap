            ...
            <Box>
                ...
                <Box p="24px">
                  <Flex justifyContent="space-between">
                    <Flex flex="1" flexDirection="column">
                      <Text color="#009999" bold fontSize="12px" textTransform="uppercase">
                        {t('Liquidity')}
                      </Text>
                    ...
                    <Flex flex="1" flexDirection="column">
                      ...
                      <Flex alignItems="center">
                        <span ref={targetRef}>
                          <HelpIcon color="#0099ff" />
                        </span>
                        <Text ml="4px" fontSize="12px" color="#0099ff">
                          {t('7D performance')}
                        </Text>
                  ...
                  <Text color="#009999" bold mt="24px" fontSize="12px" textTransform="uppercase">
                  ...
                  <LockedTokensContainer>
                    <Flex justifyContent="space-between">
                      <Flex>
                        <CurrencyLogo address={poolData.token0.address} size="24px" />
                        <Text small color="#0099ff" ml="8px">
                          {poolData.token0.symbol}
                        </Text>
                      </Flex>
              ...
              <Card mt="16px">
                <Flex flexDirection="column" p="24px">
                  ...
                  <Flex mt="24px">
                    <Flex flex="1" flexDirection="column">
                      <Text color="#009999" fontSize="12px" bold textTransform="uppercase">
                    ...
                    <Flex flex="1" flexDirection="column">
                      ...
                      <Text color="#0099ff" fontSize="12px">
