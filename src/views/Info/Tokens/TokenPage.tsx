        ...
        !tokenData.exists ? (
          ...
          <>
            ...
            <Flex justifyContent="space-between" flexDirection={['column', 'column', 'column', 'row']}>
              <Flex flexDirection="column" mb={['8px', null]}>
                <Flex alignItems="center">
                  ...
                  <Text ml="12px" lineHeight="1" color="#0099ff" fontSize={isXs || isSm ? '14px' : '20px'}>
                    ({tokenData.symbol})
                  </Text>
                </Flex>
            ...
            <ContentLayout>
              <Card>
                <Box p="24px">
                  <Text bold small color="#009999" fontSize="12px" textTransform="uppercase">
                    {t('Liquidity')}
                  </Text>
                  ...
                  <Text mt="24px" bold color="#009999" fontSize="12px" textTransform="uppercase">
                    {t('Volume 24H')}
                  </Text>
