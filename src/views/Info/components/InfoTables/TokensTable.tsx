        ...
        <Flex alignItems="center">
          ...
          {!isXs && !isSm && (
            <Flex marginLeft="10px">
              <Text color="#660033">{tokenData.name}</Text>
              <Text ml="8px" color="#00264d">({tokenData.symbol})</Text>
            </Flex>
          )}
        </Flex>
        <Text color="#ffcc00" fontWeight={400}>${formatAmount(tokenData.priceUSD, { notation: 'standard' })}</Text>
        <Text fontWeight={400}>
          <Percent value={tokenData.priceUSDChange} fontWeight={400} />
        </Text>
        <Text color="#ffcc00" fontWeight={400}>${formatAmount(tokenData.volumeUSD)}</Text>
        <Text color="#ffcc00" fontWeight={400}>${formatAmount(tokenData.liquidityUSD)}</Text>
      </ResponsiveGrid>
    </LinkWrapper>
  )
}
