      ...
      <CardBody>
        ...
        <Flex flexDirection="column" mb="24px">
          <Flex justifyContent="space-between" width="100%" pt="8px">
            <Text color="#0099ff">{t('Multiplier per farm')}</Text>
            <Text>1x {t('each')}</Text>
          </Flex>
          <Flex justifyContent="space-between" width="100%" pt="8px">
            <Text color="#0099ff">{t('Total whitelisted bidders')}</Text>
            <WhitelistedBiddersButton />
          </Flex>
        </Flex>

        <Flex justifyContent="space-between" mb="8px">
          <Text color="#0099ff">{t('Your total bid')}</Text>
          <Text>{getBalanceNumber(amount).toLocaleString()} CAKE</Text>
        </Flex>
        <Flex justifyContent="space-between">
          <Text color="#0099ff">{t('Your position')}</Text>
          <Text>#{position}</Text>
        </Flex>
      </CardBody>
