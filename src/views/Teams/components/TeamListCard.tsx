      ...
      <Flex style={{background:"linear-gradient(180deg,#ffe6e6 0%,#ffe066 100%)"}}>
        ...
        <Body>
          <Info>
            ...
            <Text as="p" color="#000000" pr="24px" mb="16px">
              {t(team.description)}
            </Text>
            <Flex>
              <Flex>
                ...
                <Text color="#003300" fontSize="24px" bold>
          ...
          <Button as={Link} to={`/teams/${team?.id}`} variant="primary"  scale="sm" style={{backgroundColor:'#ffffff'}}>
            {t('See More')}
          </Button>
