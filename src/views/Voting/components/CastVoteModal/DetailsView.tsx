...
const DetailsView: React.FC<DetailsViewProps> = ({
  ...
  return (
    <ModalInner mb="0">
      <Text as="p" mb="24px" fontSize="14px" color="#0099ff">
        {t(
      ...
      <Text color="#009999" textTransform="uppercase" mb="4px" bold fontSize="14px">
        {t('Overview')}
      </Text>
      <VotingBox>
        <Text color="#009999">{t('Your Voting Power')}</Text>
