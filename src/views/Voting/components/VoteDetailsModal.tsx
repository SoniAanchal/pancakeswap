...
const VoteDetailsModal: React.FC<VoteDetailsModalProps> = ({ block, onDismiss }) => {
  ...
  return (
    <Modal title={t('Voting Power')} onDismiss={handleDismiss} headerBackground={theme.colors.primaryBright}>
      <Box mb="24px" width="320px">
        {isLoading ? (
          ...
          <>
            ...
            />
            <Button variant="primary"  onClick={onDismiss} width="100%" mt="16px">
              {t('Close')}
            </Button>
          </>
        )}
