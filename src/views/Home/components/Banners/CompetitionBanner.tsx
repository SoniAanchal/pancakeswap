...
const StyledHeading = styled(Heading)`
  color: #ffffff;
  background: -webkit-linear-gradient(#009999 0%, #3399ff 100%);
  background-clip: text;
  -webkit-background-clip: text;
...
const Wrapper = styled.div`
  border-radius: 32px;
  width: 100%;
  background-image: linear-gradient(#009999, #3399ff);
      ...
      <Inner>
        ...
        <RightWrapper>
          <Flex flexDirection="column" justifyContent="center" >
            <StyledSubheading color='#00334d'>{t('Binance Fan Token Trading Competition')}</StyledSubheading>
