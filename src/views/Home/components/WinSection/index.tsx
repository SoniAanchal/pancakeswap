...
const PredictionCardData: IconCardData = {
  ...
  background: 'linear-gradient(180deg, #0077b3 0%, #00aaff 51.17%, #b3e6ff 100%);',
  borderColor: '#0077b3',
  rotation: '-2.36deg',
}

const LotteryCardData: IconCardData = {
  icon: <TicketFillIcon color="black" width="36px" />,
  background: ' linear-gradient(180deg, #330014 0%, #800033 51.17%, #ff99c2 100%);',
  borderColor: '#330014 ',
  rotation: '1.43deg',
}
    ...
    <>
      ...
      <TransparentFrame isDark={theme.isDark}>
        <Flex flexDirection="column" alignItems="center" justifyContent="center">
          <ColoredWordHeading textAlign="center" text={t('Win millions in prizes') } color=" #33001a"/>
          <Text color=" #0066cc">{t('Provably fair, on-chain games.')}</Text>
          <Text mb="40px" color=" #0066cc">
